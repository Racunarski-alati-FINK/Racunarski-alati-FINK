...
## Drugi zadatak
Napisati program koji otvara fajl listing.txt koji sadrži spisak brojeva telefona u formatu:  
...
Napisati program koji otvara fajl raspored.txt koji sadrži dnevni raspored filmova u bioskopu u formatu:
